...
(function () {
  ...
  function styles() {
    ...
    s.textContent = [
      ...
      '.vrtc-in{background:#F0F4F7;border:1px solid #E4E7EF;border-left:4px solid #C24E00;',
      '  border-radius:10px;padding:28px 30px}',
      '.vrtc-libre{display:flex;gap:8px;align-items:flex-start;margin:0 0 13px;',
      '  font-size:13.5px;line-height:1.5;color:#007E11;font-weight:500}',
      '.vrtc-libre svg{width:16px;height:16px;flex:0 0 16px;margin-top:2px;fill:none;',
      '  stroke:#007E11;stroke-width:2.2;stroke-linecap:round;stroke-linejoin:round}',
      '.vrtc-t{margin:0 0 11px;font-size:24px;line-height:1.25;font-weight:600;color:#001136}',
      '.vrtc-d{margin:0 0 17px;font-size:15.5px;line-height:1.7;color:#4D5163}',
      '.vrtc-prix{display:none;margin:0 0 19px;padding:11px 15px;background:#fff;',
      '  border:1px solid #E4E7EF;border-radius:6px;font-size:15px;color:#001136}',
      '.vrtc-prix b{font-weight:600;color:#C24E00}',
      '.vrtc-act{display:flex;flex-wrap:wrap;gap:12px;align-items:center}',
      '.vrtc-b{display:inline-block;padding:14px 26px;border-radius:6px;font-size:15px;',
      '  font-weight:500;text-decoration:none;transition:background .16s,border-color .16s}',
      '.vrtc-b1{background:#C24E00;color:#fff}',
      '.vrtc-b1:hover{background:#A34100}',
      '.vrtc-b2{background:#fff;color:#1E499B;border:1px solid #D3D9E6}',
      '.vrtc-b2:hover{border-color:#1E499B}',
      '.vrtc-res{display:flex;align-items:center;gap:7px;margin-top:15px;',
      '  font-size:12.5px;color:#6E7385}',
      '.vrtc-res svg{width:14px;height:14px;flex:0 0 14px;fill:none;stroke:#6E7385;',
      '  stroke-width:2;stroke-linecap:round;stroke-linejoin:round}',
      '@media (max-width:620px){',
      '  .vrtc{margin:32px auto;padding:0 16px}',
      '  .vrtc-in{padding:22px 19px;border-left-width:3px}',
      '  .vrtc-t{font-size:20px}.vrtc-d{font-size:14.5px}',
      '  .vrtc-b{width:100%;text-align:center}}',
      '@media (prefers-color-scheme:dark){',
      '  .vrtc-in{background:#111A2E;border-color:#24304C}',
      '  .vrtc-t{color:#EEF2F9}.vrtc-d{color:#B3BCCF}',
      '  .vrtc-prix{background:#0C1425;border-color:#24304C;color:#EEF2F9}',
      '  .vrtc-b2{background:#0C1425;color:#8FB0E8;border-color:#24304C}}'
    ].join('');
