...
(function () {
  ...
  function styles() {
    ...
    s.textContent = [
      ...
      '.vrtc-in{background:#FAFBFE; border:1px solid #E4E9F2;',
      '  border-radius:16px; padding:30px 32px;',
      '  box-shadow:0 8px 24px rgba(20,37,84,.07)}',
      ...
      '  font-size:15px;color:#16233F}',
      '.vrtc-prix b{font-weight:600;color:#A84200}',
      ...
      '.vrtc-b1{background:#1E499B;color:#fff}',
      '.vrtc-b1:hover{background:#163A7D}',
      '.vrtc-b2{background:#fff;border:1.5px solid #1E499B;color:#1E499B}',
      '.vrtc-b2:hover{background:#EEF3FC}',
      '.vrtc-res{display:flex;align-items:center;gap:7px;margin-top:16px;',
      '  font-size:12.5px;color:#5A6480}',
      '.vrtc-res svg{width:14px;height:14px;flex:0 0 14px;fill:none;stroke:#5A6480;',
